                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>Data type of Company</span>
                                </li>
                            </ul>
                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                        <form class="form-horizontal" role="form" name="pagetypeform" action="<?php echo URL.'pagemanager/datacompaniesAdd'?>" method="POST">
                                            <div class="form-body">
                                            	<div class="form-group">
                                                    <label class="col-md-3 control-label">Name</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" placeholder="Enter Sponsor Type name" name="sptname" value="" required>
                                    	...
                                    	<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                	<td class="hidden"></td>
                                                    <td><?php echo $a;?></td> 
                                                    <td><?php echo $value['spname'];?></td> 
                                                    <td><?php if($value['spstatus'] == 1){?><span class="label label-sm label-info"> Active </span><?php }else if($value['spstatus'] == 0){?><span class="label label-sm label-danger"> Disable </span><?php }?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right" role="menu">
                                                                <li>
                                                                    <a class="font-yellow" href="<?php echo URL.'pagemanager/pagetypeedit/'.@$value['spid'];?>">
