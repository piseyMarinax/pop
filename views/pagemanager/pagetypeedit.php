                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                        <form class="form-horizontal" role="form" name="pagetypeform" action="<?php echo URL.'pagemanager/pagetypeEditSave'?>" method="POST">
                                            <div class="form-body">
                                            	<div class="form-group">
                                                    <label class="col-md-3 control-label">Name</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" placeholder="Enter the page name" name="pagename" value="<?php echo $this->pageSingle[0]['pt_name'];?>" required>
                                                        <input type="hidden" class="form-control" name="ptid" value="<?php echo $this->pageSingle[0]['ptid'];?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" name="cblstatus">
                                                        	<?php $status = $this->pageSingle[0]['pt_status'];?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea class="form-control description" rows="3" name="des"><?php echo @$this->pageSingle[0]['pt_des'];?></textarea>
                                                    </div>
                                                </div>
                                            </div>
