            ...
            <div class="page-footer">
                <div class="page-footer-inner"> &copy; 2017 - <?php echo date('Y');?> POP CAMBODIA. | Developed by
                    <a target="_blank" href="http://pingitgroup.com">PING IT GROUP</a>
...
<![endif]-->
        ...
        <script>
            $(document).ready(function()
            {
				...
				function setSidebar(){
					...
					$.ajax({
						url: 'http://'+document.domain+'/config/sidebar.php',
						type: 'POST',
						data: {'_token': _token},
						datatype: 'json',
    ...
    <!-- date picker script -->    
    <script type="text/javascript" src="/admin/datepicker/js/jquery.datepicker.js"></script>
    <!--end date picker script -->
    
    <!--script Add Update-->
    <!--<link href="/assets/ajax_login/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen">
    <script type="text/javascript" src="<?php echo URL;?>assets/ajax_login/jquery-1.11.3-jquery.min.js"></script>-->
    <script type="text/javascript" src="<?php echo URL;?>assets/ajax_login/validation.min.js"></script>
    <script src="<?php echo URL;?>assets/ajax_login/addUpdate_script.js?<?=time()?>"></script>
    
    <!--end script Add Update-->
    </body>
</html>